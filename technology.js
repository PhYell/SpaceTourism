...
function changeTab(tab){
    ...
    switch(tab){
        case 1:
            ...
            if($(window).width() > 1100) $(".techTab img").attr("src", "assets/technology/image-launch-vehicle-portrait.jpg");
            else $(".techTab img").attr("src", "assets/technology/image-launch-vehicle-landscape.jpg");   
            break;
        case 2:
            ...
            if($(window).width() > 1100) $(".techTab img").attr("src", "assets/technology/image-spaceport-portrait.jpg");
            else $(".techTab img").attr("src", "assets/technology/image-spaceport-landscape.jpg")
            break;
        case 3:
            ...
            if($(window).width() > 1100) $(".techTab img").attr("src", "assets/technology/image-space-capsule-portrait.jpg");
            else $(".techTab img").attr("src", "assets/technology/image-space-capsule-landscape.jpg")
            break;
    }
}